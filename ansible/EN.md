...
Ansible provides porting guides to help you keeping up-to-date: [Ansible Porting Guides](https://docs.ansible.com/ansible/latest/porting_guides/porting_guides.html)
